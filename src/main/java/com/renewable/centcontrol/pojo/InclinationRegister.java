...
public class InclinationRegister {
    ...
    public InclinationRegister(Integer id, Integer terminalId, Integer sensorId, Double radius, Double initH1, Double initAngle1, Double initH2, Double initAngle2, Double initH3, Double initAngle3, Double initH4, Double initAngle4, Double initTotalAngle, Double initDirectAngle, Double totalAngleLimit, Double totalInitAngleLimit, Double initX, Double initY, Date createTime, Date updateTime) {
        this.id = id;
